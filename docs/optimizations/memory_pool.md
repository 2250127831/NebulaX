...
|:----|:---:|:---:|:---:|:---:|:----:|
| 1 | 11,329,057 | 355ms | 80ms | 1016ms | 1481ms |
| 2 | 13,246,721 | 324ms | 268ms | 970ms | 987ms |
| 3 | 12,022,682 | 345ms | 39ms | 933ms | 1511ms |
| **均** | **12,199,486** | **341ms** | **129ms** | **973ms** | **1326ms** |

三轮波动较大（11.3M~13.2M），QPS 和 P50 均受 epoll 批处理影响——某轮 epoll 正好短时间 drain 全部连接时 P50 降至 39ms，反之则高达 268ms。尾延迟 P999 普遍在 1 秒以上（Phase 6 报告 P999=1,428ms），这是 epoll ET drain 循环的固有问题。
