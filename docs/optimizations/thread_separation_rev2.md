...
| 轮次 | Phase 4 QPS | Phase 5 rev2 QPS | rev2 avg | rev2 P50 | rev2 P99 | rev2 P999 |
|:----|:----------:|:----------------:|:--------:|:--------:|:--------:|:--------:|
| 1 | 6,582,238 | 8,467,544 | 14.4ms | 15.5ms | 27.4ms | 27.6ms |
| 2 | 7,422,582 | 8,226,120 | 16.8ms | 17.0ms | 30.3ms | 30.6ms |
| 3 | 8,206,408 | 8,841,889 | 14.3ms | 14.1ms | 27.4ms | 28.0ms |
| **均** | **7,403,743** | **8,511,851** | **15.2ms** | **15.5ms** | **28.4ms** | **28.7ms** |

#### Pipeline（50M sustained）

| 轮次 | Phase 4 QPS | Phase 5 rev2 QPS | rev2 avg | rev2 P50 | rev2 P99 | rev2 P999 |
|:----|:----------:|:----------------:|:--------:|:--------:|:--------:|:--------:|
| 1 | 4,371,021 | 7,513,994 | 43.7ms | 33.1ms | 85.5ms | 90.9ms |
| 2 | 3,592,313 | 7,333,043 | 32.0ms | 27.0ms | 64.9ms | 66.3ms |
| 3 | 4,471,429 | 6,766,662 | 29.4ms | 23.0ms | 66.0ms | 67.1ms |
| **均** | **4,144,921** | **7,204,566** | **35.0ms** | **27.7ms** | **72.1ms** | **74.8ms** |
